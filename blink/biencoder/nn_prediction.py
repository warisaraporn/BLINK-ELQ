...
def get_topk_predictions(
    ...
    if silent:
        ...
        print(f'train_dataloader: {train_dataloader.size}')
        print(f'candidate_pool: {candidate_pool.size}')
        print(f'cand_encode_list: {cand_encode_list.shape}')
    ...
    for step, batch in enumerate(iter_):
        ...
        print(f'context_input: {context_input.size}') ### number of example within the batch
        print(f'srcs: {srcs.shape} \n {srcs}')
        src = srcs[0].item()
